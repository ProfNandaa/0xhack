...
def poison_target(gateway_ip, gateway_mac, target_ip, target_mac):
	...
	print "[*] ARP poison slack finished."
	return
...
# start poison thread
poison_thread = threading.Thread(target=poisonn_target, args=(gateway_ip, gateway_mac, target_ip, target_mac))
poison_thread.start()
